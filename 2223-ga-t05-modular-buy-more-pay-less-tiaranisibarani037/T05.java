...
public class T05 {
    ...
    public static void main(String[] args) {
        ...
        totalHargaAkhir = 0;
        collectdata(totalHarga, totalHargaAkhir);
        output(totalHarga, totalHargaAkhir);
    }
    
    public static void collectdata(double[] totalHarga, double totalHargaAkhir) {
    ...
    public static double output(double[] totalHarga, double totalHargaAkhir) {
